...
namespace ShipyardExpansion
{
    internal class BrigPatches
    {
        ...
        public static void Patch(Transform boat, BoatCustomParts partsList, BoatRefs boatRefs)
        {
            ...
            mainMast1.GetComponent<BoatPartOption>().childOptions = mainMast1.GetComponent<BoatPartOption>().childOptions.AddRangeToArray(new GameObject[] { thing.transform.Find("crowsnest_main").GetChild(0).gameObject, modWalkCol.Find("crowsnest_main").GetChild(0).gameObject, tops_main.GetChild(0).gameObject, tops_main.GetComponent<BoatPartOption>().walkColObject.transform.GetChild(0).gameObject, thing.transform.Find("telltale_main/telltale_main_cont").GetChild(0).gameObject, thing.transform.Find("telltale_main/telltale_main_cont2").GetChild(0).gameObject });
            mainMast2.GetComponent<BoatPartOption>().childOptions = mainMast2.GetComponent<BoatPartOption>().childOptions.AddRangeToArray(new GameObject[] { thing.transform.Find("crowsnest_main").GetChild(1).gameObject, modWalkCol.Find("crowsnest_main").GetChild(1).gameObject, tops_main.GetChild(1).gameObject, tops_main.GetComponent<BoatPartOption>().walkColObject.transform.GetChild(1).gameObject, thing.transform.Find("telltale_main/telltale_main_cont").GetChild(1).gameObject, thing.transform.Find("telltale_main/telltale_main_cont2").GetChild(1).gameObject });
            foreMast1.GetComponent<BoatPartOption>().childOptions = foreMast1.GetComponent<BoatPartOption>().childOptions.AddRangeToArray(new GameObject[] { thing.transform.Find("crowsnest_fore").GetChild(0).gameObject, modWalkCol.Find("crowsnest_fore").GetChild(0).gameObject, tops_fore.GetChild(0).gameObject, tops_fore.GetComponent<BoatPartOption>().walkColObject.transform.GetChild(0).gameObject, thing.transform.Find("telltale_fore/telltale_fore_cont").GetChild(0).gameObject, thing.transform.Find("telltale_fore/telltale_fore_cont2").GetChild(0).gameObject });
            foreMast2.GetComponent<BoatPartOption>().childOptions = foreMast2.GetComponent<BoatPartOption>().childOptions.AddRangeToArray(new GameObject[] { thing.transform.Find("crowsnest_fore").GetChild(1).gameObject, modWalkCol.Find("crowsnest_fore").GetChild(1).gameObject, tops_fore.GetChild(1).gameObject, tops_fore.GetComponent<BoatPartOption>().walkColObject.transform.GetChild(1).gameObject, thing.transform.Find("telltale_fore/telltale_fore_cont").GetChild(1).gameObject, thing.transform.Find("telltale_fore/telltale_fore_cont2").GetChild(1).gameObject });
            partsList.availableParts[12].partOptions[0].childOptions = partsList.availableParts[12].partOptions[0].childOptions.AddRangeToArray(new GameObject[] { thing.transform.Find("crowsnest_main").GetChild(0).Find("ladder_shr_0").gameObject, thing.transform.Find("crowsnest_main").GetChild(1).Find("ladder_shr_0").gameObject, thing.transform.Find("telltale_main").GetChild(1).gameObject });
            partsList.availableParts[12].partOptions[1].childOptions = partsList.availableParts[12].partOptions[1].childOptions.AddRangeToArray(new GameObject[] { thing.transform.Find("crowsnest_main").GetChild(0).Find("ladder_shr_1").gameObject, thing.transform.Find("crowsnest_main").GetChild(1).Find("ladder_shr_1").gameObject, thing.transform.Find("telltale_main").GetChild(0).gameObject });
            partsList.availableParts[11].partOptions[0].childOptions = partsList.availableParts[11].partOptions[0].childOptions.AddRangeToArray(new GameObject[] { thing.transform.Find("crowsnest_fore").GetChild(0).Find("ladder_shr_0").gameObject, thing.transform.Find("crowsnest_fore").GetChild(1).Find("ladder_shr_0").gameObject, thing.transform.Find("telltale_fore").GetChild(1).gameObject, thing.transform.Find("mast_fore/static_rig").gameObject, modWalkCol.Find("mast_fore/static_rig").gameObject, thing.transform.Find("mast_fore (1)/static_rig").gameObject, modWalkCol.Find("mast_fore (1)/static_rig").gameObject });
            partsList.availableParts[11].partOptions[1].childOptions = partsList.availableParts[11].partOptions[1].childOptions.AddRangeToArray(new GameObject[] { thing.transform.Find("crowsnest_fore").GetChild(0).Find("ladder_shr_1").gameObject, thing.transform.Find("crowsnest_fore").GetChild(1).Find("ladder_shr_1").gameObject, thing.transform.Find("telltale_fore").GetChild(0).gameObject, thing.transform.Find("mast_fore/shrouds_alt_F1").gameObject, modWalkCol.Find("mast_fore/shrouds_alt_F1").gameObject, thing.transform.Find("mast_fore (1)/shrouds_alt_F0").gameObject, modWalkCol.Find("mast_fore (1)/shrouds_alt_F0").gameObject });
